    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.categoryContainer}>
        ...
        <TouchableOpacity
          style={styles.categoryBtn}
          onPress={() =>
            navigation.navigate('PaybyeBesimScreen', {title: 'ระบุจำนวนเงิน'})
          }>
          <View style={styles.categoryIcon}>
            <MaterialCommunityIcons name="zigbee" size={35} color="#FF6347" />
          </View>
          <Text style={styles.categoryBtnTxt}> แบบ eBeSim</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.categoryBtn}
          onPress={() => {
          ...
          <View style={styles.categoryIcon}>
            <MaterialCommunityIcons name="qrcode" size={35} color="#FF6347" />
          </View>
          <Text style={styles.categoryBtnTxt}>QR พร้อมเพย์</Text>
        </TouchableOpacity>
      </View>
      <View style={[styles.categoryContainer, {marginTop: 10}]}>
        ...
        <TouchableOpacity
          ...
          <View style={styles.categoryIcon}>
            <MaterialIcons name="star" size={35} color="#FF6347" />
          </View>
          <Text style={styles.categoryBtnTxt}>แผนรายได้</Text>
        </TouchableOpacity>
      </View>
