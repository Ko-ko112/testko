    ...
    <View style={styles.container}>
      ...
      <Animated.View
        ...
        <TouchableOpacity onPress={() => this.bs.current.snapTo(0)}>
         ...
         />
          ...
          <Text style={{ fontWeight: 'bold'}}>หมวดสินค้า</Text>
           ...
           >
          <Picker.Item label="อาหารตามสั่ง" value="Food" />
          <Picker.Item label="เครื่องดื่ม" value="Braverage" />
          </Picker> 
          </View>
        ...
        <TouchableOpacity style={styles.commandButton} onPress={() => {}}>
          <Text style={styles.panelButtonTitle} onPress={checkTextInput} >แก้ไขสินค้า</Text>
        </TouchableOpacity>
      </Animated.View>
    </View>
    </ScrollView>
